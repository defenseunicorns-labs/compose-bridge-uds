...
| `networks:`                                                      | Service membership is preserved with Pod labels and selector-scoped UDS ingress and egress rules when services use different network sets. Network aliases, addresses, and driver options remain unsupported.                                                                    |
